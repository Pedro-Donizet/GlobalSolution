...
const Informacao = () => {
  ...
  <section className="section-text-img">
    ...
    <div>
      <Image src="/drawing1.png" alt="drawing" width={400} height={400}></Image>
    </div>
  </section>

  <section className="section-text-img">
    <div>
      <Image src="/drawing2.png" alt="drawing" width={400} height={400}></Image>
    </div>
  ...
  <section className="section-text-img">
    ...
    <div>
      <Image src="/drawing.png" alt="drawing" width={400} height={400}></Image>
    </div>
    </section>
  </>
  )
